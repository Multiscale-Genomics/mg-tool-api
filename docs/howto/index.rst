...
-----------------------
When it comes to developing the code all the code should stick to a common standard. This has been defined within http://multiscale-genomics.readthedocs.io/en/latest/coding_standards.html as well as how to set up the licenses correctly so that your package can be integrated.

Adding a new function
---------------------

`Wrapping a Tool <http://mg-tool-api.readthedocs.io/en/latest/howto_tool.html>`_
...
`Adding a tool to a pipeline <http://mg-tool-api.readthedocs.io/en/latest/howto_pipeline.html>`_
...
`Configuration <http://mg-tool-api.readthedocs.io/en/latest/howto_config.html>`_
