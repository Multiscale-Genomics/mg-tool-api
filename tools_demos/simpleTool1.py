...
try:
    ...
    from mg_tool_api.utils.dummy_pycompss import FILE_IN, FILE_OUT  # pylint: disable=ungrouped-imports
    from mg_tool_api.utils.dummy_pycompss import task  # pylint: disable=ungrouped-imports
